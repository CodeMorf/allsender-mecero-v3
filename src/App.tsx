...
function KitchenPanel({ offline, places, onClose, onUpdateStatus }: { offline: boolean; places: KitchenPlace[]; onClose: () => void; onUpdateStatus: (kotId: number, status: string, idempotencyKey: string) => Promise<{ queued: boolean; message: string }> }) {
